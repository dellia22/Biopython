...
input_file = "NZ_AP017558" #Your GenBank file locataion. e.g C:\\Sequences\\my_genbank.gb
output_file_name = "NZ_AP017558Output.fasta" #The name out your fasta output
accession_numbers = [line.strip() for line in open('NZ_AP017558')] #the same as your input file, defines the headers for each sequence
